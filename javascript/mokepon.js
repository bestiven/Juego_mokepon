...
const inputHipodogue = document.getElementById('hipodogue') //creamos una variable donde guardamos el llamdo del boton 
const inputCapipepo = document.getElementById('capipepo')
const inputRatiguella= document.getElementById('ratiguella')
...
function selecionarmascota(){ //funcion que nos envia un mensaje de que se selecciono la mascota 
    ...
    if(inputHipodogue.checked)
     //alert('la mascota que seleccionaste es el hipodogue')
     spanMascotaJugador.innerHTML = ' hipodogue '

    else if (inputCapipepo.checked)
     //alert('la mascota que seleccionaste es el capipepo')
     spanMascotaJugador.innerHTML = ' capipepo '

    else if (inputRatiguella.checked)
     //alert('la mascota que seleccionaste es la ratiguella')
